...
namespace Lab2A
{
    ...
    {
        // This function creates a base variable.
        private int Base;
        ...
        /// <param name="Base">A int for the shapes base.</param>
        /// <param name="Height">A int for the shapes height.</param>
        /// 
        public Triangle(String Type, int Base, int Height)
        {
            this.Type = Type;
            this.Base = Base;
            this.Height = Height;
        ...
        /// <summary>
        /// Writes lines to the console which allows use to input values for base and height.
        /// </summary>
        ...
        /// <summary>
        /// Calulates the area for triangle.
        /// </summary>
